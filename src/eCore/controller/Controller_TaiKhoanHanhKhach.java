...
public class Controller_TaiKhoanHanhKhach extends TaiKhoanHanhKhach implements ZEController{
	...
	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "kTXCore/pages/taikhoanhanhkhachs.jsp";
	String duongDanTrangView = "kTXCore/pages/taikhoanhanhkhach.jsp";
	...
	public HanhKhach getHanhKhach() {
		...
		ArrayList<HanhKhach> list = dao_hanhKhach.listByColumns("maHanhKhach", getMaHanhKhach());
		if (list.size() > 0)
			return list.get(0);
		else
			return null;
	...
	public String delete() {
		...
		if (dao.delete(obj)) {
			session.setAttribute("msg", "XÃ³a dá»¯ liá»‡u thÃ nh cÃ´ng.");
	...
	public String doiMatKhau() {
		...
		ObjectDAO<TaiKhoanHanhKhach> dao_TaiKhoanHanhKhach = new DAO_TaiKhoanHanhKhach();
		ArrayList<TaiKhoanHanhKhach> list_TaiKhoanHanhKhach = dao_TaiKhoanHanhKhach.listByColumns("maDangNhap",
				maDangNhap);

...
@Entity
public class TaiXe implements Comparable<TaiXe>{
	@Id
	 ...
	 */
	public TaiXe(String maTaiXe, String hoTen, String hinhAnh, Date ngaySinh, String gioiTinh, String noiSinh,
	...
	public int hashCode() {
		...
		result = prime * result + ((maTaiXe == null) ? 0 : maTaiXe.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (hoTen == null) {
			...
			return false;
		if (maTaiXe == null) {
			if (other.maTaiXe != null)
				return false;
		} else if (!maTaiXe.equals(other.maTaiXe))
			return false;
		if (ngaySinh == null) {
	...
	public String toString() {
		return "TaiXe [maTaiXe=" + maTaiXe + ", hoTen=" + hoTen + ", hinhAnh=" + hinhAnh + ", ngaySinh=" + ngaySinh
				+ ", gioiTinh=" + gioiTinh + ", noiSinh=" + noiSinh + ", queQuan=" + queQuan + ", danToc=" + danToc
				+ ", tonGiao=" + tonGiao + ", diaChi=" + diaChi + ", cMND=" + cMND + ", email=" + email
				+ ", soDienThoaiDiDong=" + soDienThoaiDiDong + ", ghiChu=" + ghiChu + ", soTaiKhoan=" + soTaiKhoan
				+ ", thoiGianCapNhat=" + thoiGianCapNhat + "]";
	}

	@Override
	public int compareTo(TaiXe o) {
		// TODO Auto-generated method stub
		return this.maTaiXe.compareTo(o.maTaiXe);
	}

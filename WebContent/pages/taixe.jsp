							...
							<div class="col-lg-6">
								<div class="form-group">
									<label>Mã Tài Xế</label> <input class="form-control"
										id="maTaiXe" name="maTaiXe" onblur="thayDoiMyFileFileName()"
										value="<%=(obj != null && obj.getMaTaiXe() != null ? obj.getMaTaiXe() : "")%>"
										<%=(modeView || modeEdit ? " readonly " : "")%>>
								</div>
								<div class="form-group">
									<label>Tên Tài Xế</label> <input class="form-control"
										name="tenTaiXe"
